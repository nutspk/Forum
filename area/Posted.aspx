<%@ Page Title="" Language="C#" MasterPageFile="~/Includes/Main.Master" AutoEventWireup="true" CodeBehind="Posted.aspx.cs" Inherits="Selectcon.Posted" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>    
        ...
        function InitCtrl() {
            ...
            $.getJSON("../api/v1/Tags", function (data) {
                ...
                $.each(obj, function (idx, val) {
                    html2 += "<li id='tag"+ val.TagID +"' class='post-tag' data-tag='"+ val.TagID+ ":" +val.TagDesc +"'>"+ val.TagDesc +"</li>";
                });
                elem2.append(html2);
        ...
        function LoadData() {
            ...
            var user;
            $('#qID').val("<%=QuestionID%>");
            $.getJSON("../api/v1/Question/"+ <%=QuestionID%>, function (data) {
                var obj = $.parseJSON(data);
                $.each(obj, function (idx, val) {
                        $('#ddlCategory').val(val.CategoryID);
                        $('#title').val(val.QuestionTitle);
                        $('.note-editable').html(val.QuestionDesc);
                        console.log(val.IsPublic);
                        
                        if (val.IsPublic == 0) {
                            $('#chkPrivate').prop('checked', true);
                            $('#pnlPrivate').removeClass("d-none");
                        } else if (val.IsPublic == 1) {
                        ...
                        //        var tag = $("li#tag"+tagList[i].TagID).attr('data-tag');
                        //        $('#txtTags').tagEditor('addTag', tag);
                        //        $("li#tag" + tagList[i].TagID).addClass('d-none');
                        //    }
                        //}  
                        ...
                        if (userList != null && userList !== undefined) {
                            ...
                            for (var i = 0; i < userList.length; i++) {
                                ...
                                var name = userList[i].DisplayName;
                                mention += "@["+ name +"](contact:"+ id +") ";
                            }
        ...
        function Post() {
            ...
            $.ajax({
                ...
                url: '../api/v1/Question/edit/'+$('#qID').val(),
                data: myData,  
...
<asp:Content ID="Content2" ContentPlaceHolderID="C_mainbar" runat="server">
    ...
    <div id="ask-form">
        <div class="question-context-title"> แก้ไขกระทู้ </div>
        ...
        <div class="js-wz-element ps-relative" id="tag-editor" data-wz-state="1,256">
            <div class="ps-relative d-none">
                <div class="form-item p1 js-stacks-validation">
            ...
            <div class="grid gs8 gsx">
                <div class="grid--cell fl1 grid fd-column js-stacks-validation">
                    ...
                    <div class="fl1 ps-relative">
                        ...
                        <input id="chkPublic" name="chkDisplay" type="radio"/>
